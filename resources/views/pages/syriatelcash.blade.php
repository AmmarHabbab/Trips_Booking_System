...
<body class="bg-gray-100">
    <div class="w-full max-w-md mx-auto mt-10">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="/book/payment/syriatelcash/{{$payment->id}}" enctype="multipart/form-data">
            @csrf
                ...
                <div id="additional-inputs2" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="image">
                            Send {{$payment->amount}} using syriatel cash To this number : 0934558864 Then Enter the phone number you used to send the money
                        </label><br>
